...
namespace TestEjercicioOrdenador.MVC.Data
{
    ...
    public class TiendaOrdenadorContextTests
    {
        ...
        public void TestAddAndDeleteOrdenadorComponent()
        {
            ...
            resultComponente = repositoryComponentes.GetComponente(10000);
            resultOrdenador = repositoryOrdenadores.GetOrdenador(10000);
            ...
            repositoryComponentes.DeleteComponente(10000);
            repositoryOrdenadores.DeleteOrdenador(10000);
        }
    }
}